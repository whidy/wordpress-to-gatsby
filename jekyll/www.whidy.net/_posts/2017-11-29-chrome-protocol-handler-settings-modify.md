...
[caption id="attachment_3049" align="aligncenter" width="400"][![无法关联百度云盘程序](http://www.whidy.net/wp-content/uploads/2017/11/dl-400x235.png)](http://www.whidy.net/wp-content/uploads/2017/11/dl.png) 无法关联百度云盘程序[/caption]
...
[caption id="attachment_3050" align="aligncenter" width="400"][![设置协议程序启动的配置](http://www.whidy.net/wp-content/uploads/2017/11/settings-400x282.png)](http://www.whidy.net/wp-content/uploads/2017/11/settings.png) 设置协议程序启动的配置（配置图一）[/caption]

如果感觉阅读这些配置比较困难，可以将文档改成Javascript语言模式（当然改功能依赖各种编辑器，我这里是VSCode）就清晰了，有空的话也可以看看其他的有没有什么有趣的配置选项：

[caption id="attachment_3051" align="aligncenter" width="322"][![排版后的效果](http://www.whidy.net/wp-content/uploads/2017/11/settings-2.png)](http://www.whidy.net/wp-content/uploads/2017/11/settings-2.png) 排版后的效果（配置图二）[/caption]
